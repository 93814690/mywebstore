...
<jsp:forward page="/MainServlet?op=initIndex"></jsp:forward>
</c:if>
<div id="templatemo_body_wrapper">
  <div id="templatemo_wrapper">

<%--    <div id="templatemo_header">
      <div id="site_title"><h1><a href="http://localhost${pageContext.request.contextPath }">Online Phone Store</a>
      </h1></div>
      <div id="header_right">
        <p>
    ...
    <div id="templatemo_menubar">
      ...
      <div id="templatemo_search">
        <form action="${pageContext.request.contextPath }/ProductServlet" method="get">
          ...
          <input type="text" value="${pname }" name="pname" id="keyword" title="keyword" onfocus="clearText(this)"
              ...
              <c:forEach items="${allCategory }" var="category" varStatus="vs">
                <c:if test="${vs.index !=0}">
                  <c:if test="${vs.index != fn:length(allCategory)-1 }">
                    <li>
                      <a href="${pageContext.request.contextPath }/ProductServlet?op=byCid&num=1&sid=${category.sid}">${category.cname}</a>
                    </li>
                  </c:if>
                </c:if>
                <c:if test="${vs.index==0 }">
      ...
      <div id="content" class="float_r">
        <div id="slider-wrapper">
          <div id="slider" class="nivoSlider">
            <c:forEach items="${topProductList }" var="product">
        ...
        <h3>热门商品</h3>
        <c:forEach items="${hotProductList }" var="product" varStatus="vs">
