        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
          <tr>
            ...
            <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6">
              <div
                  align="center">
                <span class="STYLE10">品牌ID</span>
              </div>
            </td>
            <td width="15%" height="20" bgcolor="d3eaef" class="STYLE6">
              <div
                  align="center">
                <span class="STYLE10">品牌名</span>
              </div>
            </td>
          ...
          <c:forEach items="${page.pageList}" var="a" varStatus="id">
            <tr>
              <td width="4%" height="20" bgcolor="FFFFFF" class="STYLE10">
                <div align="center">
                  <input type="checkbox" name="cid" value="${a.cid}"/>
                </div>
              </td>
              <td width="10%" height="20" bgcolor="FFFFFF" class="STYLE6">
                <div align="center">
                  <span class="STYLE10">${id.index}</span>
                </div>
              </td>
              <td width="10%" height="20" bgcolor="FFFFFF" class="STYLE6">
                <div align="center">
                  <span class="STYLE10">${a.cid}</span>
                </div>
              </td>
              <td width="15%" height="20" bgcolor="FFFFFF" class="STYLE6">
                <div align="center">
                  <span class="STYLE10">${a.cname}</span>
                </div>
              </td>
              <td width="14%" height="20" bgcolor="FFFFFF" class="STYLE6">
                <div align="center">
                   <span class="STYLE10">
                   <a href="${pageContext.request.contextPath}/admin/CategoryServlet?op=toUpdateCategory&cid=${a.cid}">编辑 </a>|
                   <a href="${pageContext.request.contextPath}/admin/CategoryServlet?op=deleteCategory&cid=${a.cid}">删除</a>
                   </span>
                </div>
              </td>
            </tr>
                  ...
                  <td width="49">
                    <div align="center">
                      <span class="STYLE22"><a
                          href="${pageContext.request.contextPath }/admin/CategoryServlet?op=findAllCategory&num=${page.totalPageNum }">尾页</a></span>
                    </div>
                  </td>
