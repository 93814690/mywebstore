...
<body>
 ...
 <form method="post" action="${pageContext.request.contextPath }/admin/ProductServlet?op=updateProduct&pid=${product.pid}&imgurl=${product.imgurl}" enctype="multipart/form-data">
                ...
                <select name="cid" id="st" onchange="change()" >
                  <c:forEach items="${allCategory}" var="category">
                    <option value="${category.cid}"
                            <c:if test="${product.cid==category.cid}">selected="selected"</c:if>>
