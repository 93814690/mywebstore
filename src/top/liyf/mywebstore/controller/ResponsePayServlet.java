...
//处理支付结果
@WebServlet(name = "ResponsePayServlet", value = "/ResponsePayServlet")
public class ResponsePayServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //数据校验
        boolean ok = PaymentUtil.verifyCallback(hmac, p1_MerId, r0_Cmd, r1_Code, r2_TrxId,
        ...
        if (!ok) {
            ...
            if ("1".equals(r1_Code)) {
                ...
                try {
                    orderService.successOrder(r6_Order);
